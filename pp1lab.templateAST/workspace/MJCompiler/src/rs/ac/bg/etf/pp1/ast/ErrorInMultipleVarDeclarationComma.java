...
public class ErrorInMultipleVarDeclarationComma extends Var_list {

    private Var_part var_part;

    public ErrorInMultipleVarDeclarationComma (Var_part var_part) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ErrorInMultipleVarDeclarationComma(\n");
